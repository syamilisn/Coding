...
#define SLAVE_DEVICE_NAME       ( "solomon,ssd1306fb-i2c" )              // Device and Driver Name
...
{
	pr_info("Probe starting...");

	if(client->addr != SSD1306_SLAVE_ADDR){
...
static void etx_oled_remove(struct i2c_client *client)
{
 ...
 static const struct of_device_id etx_oled_of_id[] = {
    { .compatible = "solomon,ssd1306fb-i2c",},
    { }
 }
 MODULE_DEVICE_TABLE(of, etx_oled_of_id);
/*
